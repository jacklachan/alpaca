...
| `anthropic` | 1.2.0 | UNKNOWN (not installed in this environment) |
| `anyio` | 4.14.2 | MIT |
| `APScheduler` | 3.11.3 | MIT |
| `certifi` | 2026.7.22 | MPL-2.0 |
| `charset-normalizer` | 3.5.1 | MIT |
| `click` | 8.5.0 | BSD-3-Clause |
| `docstring-parser` | 0.18.0 | UNKNOWN (not installed in this environment) |
| `exceptiongroup` | 1.3.1 _python_version < "3.11"_ | UNKNOWN (not installed in this environment) |
| `fastapi` | 0.141.1 | MIT |
| `h11` | 0.16.0 | MIT |
| `httpcore` | 1.0.9 | BSD-3-Clause |
| `httpcore2` | 2.12.0 | UNKNOWN (not installed in this environment) |
| `httpx` | 0.28.1 | BSD-3-Clause |
| `httpx2` | 2.12.0 | UNKNOWN (not installed in this environment) |
| `idna` | 3.19 | BSD-3-Clause |
| `jiter` | 0.16.0 | UNKNOWN (not installed in this environment) |
...
| `six` | 1.17.0 | MIT |
| `sniffio` | 1.3.1 | UNKNOWN (not installed in this environment) |
| `sseclient-py` | 1.9.0 | Apache Software License v2 |
| `starlette` | 1.6.0 | BSD-3-Clause |
| `truststore` | 0.10.4 | UNKNOWN (not installed in this environment) |
